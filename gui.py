...
def sortingWindow():
  ...
  rightCol = [
    ...
    [sg.Text('Choose Your Desired Algortihm', justification = 'center', font= ('Arial', 16))],
    [sg.Text('', size = (10, 2))],
    [sg.Frame('Sorting Algorithms', button_layout)],
    [sg.Text('', size = (10, 2))],
    [sg.Slider(orientation = 'h', range = (2, 100), default_value = 45, size = (40, 20), key ='-SLIDER-', enable_events = True)],
    [sg.Text('', size = (10, 1))],
    [sg.Button('Generate', font = (20), size = (15, 2), pad = (10, 10), key = '-GEN-'), sg.Button('Clear', font = (20), size = (15, 2), pad = (10, 10), key = '-CLR-')]
  ...
  layout = [
    ...
    sg.Column(leftCol),
    sg.VSeparator(),
    sg.Column(rightCol, vertical_alignment = 'center', element_justification = 'center')
    ]
  ]
...
def mainWindow():
  ...
  rightCol = [
    [sg.Text("AlgoVisualizer", justification = 'center', font = ('Arial', 32), size = (60, 1))],
    [sg.Text("A way to make learning Algorithms Simpler", justification = 'center', font = ('Arial', 21), size = (60, 1))],
    [sg.Text("Choose Your Preferred Algorithm Sub-Group", justification = 'center', font = ('Arial', 16), size = (60, 1))],
    [sg.Text("_" * 150)],
    [sg.Text(" ", size = (50, 5))],
    [sg.Button("Sorting Algorithm", font = ('Arial', 20), pad = (4, 2), size = (20, 2), key = '-SORTWIN-')],
    [sg.Text(" ", size = (50, 1))],
    [sg.Button("PathFinding Algorithm", disabled = True, font = ('Arial', 20), pad = (4, 2), size = (20, 2))]
    ]
